...
def similarity(embed_i, embed_j):
...
class sbert():
    ...
    def get_doc_embeddings(self, sens):
        # -----------------------------------------------
        ...
        # -----------------------------------------------
        sentences_index = [self.tokenizer.encode(" ".join(s), add_special_tokens=True, max_length=128) for s in sentences]
